...
export type ExtractTupleLiteral<T extends StringifiableTuplePrimitive> = T[0] extends infer U
...
export type ReviverFN<R = unknown, T = any, K extends string = string> = FN<R, [key: K, value: T]>;
